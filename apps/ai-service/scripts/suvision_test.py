...
# Import all 6 of our exercise trackers
...
def run_local_test():
    ...
    print("Press 1-6 to switch exercises. Press 'q' to quit.")
    ...
    while cap.isOpened():
        ...
        menu_text = "[1] Bicep [2] Squat [3] Jacks [4] Push-Up [5] Press [6] Sit-Up [Q] Quit"
