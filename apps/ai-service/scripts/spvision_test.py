...
# Import all 5 of our exercise trackers
from app.engine.excercises.bicep_curl import BicepCurlTracker
from app.engine.excercises.squat import SquatTracker
# Note: Adjust the import name to jumping_jacks if you named your file with an 's'
...
def run_local_test():
    ...
    print("Press 1-5 to switch exercises. Press 'q' to quit.")
    ...
    while cap.isOpened():
        ...
        if landmarks:
            ...
            # Right Arm/Leg Stats (Adjusted X coordinate to push it to the right)
        ...
        # Bottom Footer showing controls
        menu_text = "[1] Bicep [2] Squat [3] Jacks [4] Push-Up [5] Press [Q] Quit"
        cv2.putText(annotated_frame, menu_text, (10, 460), 
