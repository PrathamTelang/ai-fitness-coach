...
# Import all 9 of our exercise trackers
...
def run_local_test():
    ...
    print("Press 1-9 to switch exercises. Press 'q' to quit.")
    ...
    while cap.isOpened():
        ...
        menu_text_2 = "[5] Press [6] Sit-Up [7] Lat Raise [8] Plank [9] Lunge [Q] Quit"
